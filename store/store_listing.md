# Tabiu — Play Store Mağaza Metinleri
...
```
Yasaklı kelimelere değmeden anlat, takımını kazandır! Gerçek zamanlı tabu oyunu.
```
...
## Kategori
- Uygulama türü: **Oyun**
- Kategori: **Kelime** (Word) veya **Sıradışı (Casual)**

## Etiketler / Anahtar kelimeler (fikir)
tabu, kelime oyunu, parti oyunu, takım oyunu, çok oyunculu, arkadaş, anlatma oyunu

## İletişim e-postası
denizkusueren61@gmail.com

## Görsel varlıklar (hazır)
- Uygulama ikonu 512×512: `tool/play_store_icon.png`
- Feature graphic 1024×500: `tool/play_feature_graphic.png`
- Telefon ekran görüntüleri: en az 2 adet (16:9 veya 9:16, min 320px) — eklenecek
